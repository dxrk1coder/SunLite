    ...
    <>
      ...
      {isAdding && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900 border border-slate-800 w-full max-w-lg p-8 md:p-10 rounded-[2.5rem] shadow-2xl animate-scale-in max-h-[90vh] overflow-y-auto custom-scrollbar z-50">
             <div className="flex justify-between items-center mb-8">
                <h2 className="text-2xl font-minecraft text-emerald-400 uppercase tracking-widest">YANGI FOYDALANUVCHI</h2>
                <button onClick={() => setIsAdding(false)} className="p-2 bg-slate-800 hover:bg-slate-700 rounded-xl transition-all">
             ...
             <form onSubmit={handleAddUser} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2 px-1">Nickname</label>
                    <input 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2 px-1">Rol</label>
                    <select 
